...
- A modern web UI (React) that mirrors the Hugging Face Purview SIT Generator and adds full scan -> results -> SIT build -> export workflows
...
### Purview SIT Generator (text analyze + redact)
